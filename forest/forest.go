...
func MinSplit(n int) func(Configer) {
...
func MinLeaf(n int) func(Configer) {
	return func(c Configer) {
		c.setMinLeaf(n)
	}
}
...
func Impurity(f tree.ImpurityMeasure) func(Configer) {
	return func(c Configer) {
		c.setImpurity(f)
	}
}
...
func MaxFeatures(n int) func(Configer) {
	return func(c Configer) {
		c.setMaxFeatures(n)
	}
}
...
func NumTrees(n int) func(Configer) {
	return func(c Configer) {
		c.setNumTrees(n)
	}
}
...
func NumWorkers(n int) func(Configer) {
	return func(c Configer) {
		c.setNumWorkers(n)
	}
}
...
func ComputeOOB(c Configer) {
	c.setComputeOOB()
}

// EarlyStop will add trees (up to the limit set by NumTrees) until the
// out of bag error estimate converges.
func EarlyStop(c Configer) {
	c.setEarlyStop()
}
